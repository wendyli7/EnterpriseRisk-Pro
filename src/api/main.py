...
def home() -> str:
    ...
    <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <style>
        ...
        h1 { margin: 0 0 12px; color: #123b63; } p { line-height: 1.7; }
        ...
        a:hover { background: #dceefa; } small { color: #64748b; }
      </style>
    </head>
    <body><main><section>
      <h1>企业风险画像平台</h1>
      <p>根据企业工商、财务、司法、行政处罚和舆情信息，生成风险评分和风险等级。</p>
      <p><strong>普通用户：</strong>使用中文页面；<strong>开发人员：</strong>使用接口文档。</p>
      <div class="links">
        <a href="/companies?limit=20">查看企业列表</a>
        <a href="/company/1">查看 1 号企业详情</a>
        <a href="/risk/1">查看 1 号企业风险评分</a>
